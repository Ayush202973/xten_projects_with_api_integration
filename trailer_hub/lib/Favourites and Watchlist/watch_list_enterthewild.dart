...
class WatchListEnterTheWild extends StatefulWidget {
  const WatchListEnterTheWild({super.key});

  @override
  State<WatchListEnterTheWild> createState() => _WatchListEnterTheWildState();
}

class _WatchListEnterTheWildState extends State<WatchListEnterTheWild> {
